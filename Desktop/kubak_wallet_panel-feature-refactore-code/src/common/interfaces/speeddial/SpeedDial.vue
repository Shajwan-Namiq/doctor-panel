    ...
    <slot name="button" :toggle="onClick">
      ...
      >
        <img
          ...
          style="
            border: 2px solid var(--primary-color-kubak);
      ...
      <template v-for="(item, index) of model" :key="index">
        ...
        >
          <template v-if="!$slots.item">
            <div v-if="mapDial" @click="onItemClick($event, item)">
              <div class="mapOption" @click="onClick($event)">
                <img
                  class="h-full w-full border-round-lg"
                  :src="item.image"
...
export default {
  ...
  methods: {
    newImageUrl() {
      let imageee;
      fetch("/src/static/images/map/darkStreet.png")
...
.mapOption {
  ...
  &:hover {
    img {
      border: 2px solid var(--primary-color-kubak) !important;
    }
  }
}
</style>

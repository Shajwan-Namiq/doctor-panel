...
<template>
  ...
  >
    ...
    <span v-else-if="hideContent && hideIndicator" class="h-full">
      <slot name="value" :value="modelValue" :placeholder="placeholder">{{
        label === "p-emptylabel" ? "&nbsp;" : label || "empty"
      }}</slot></span
    >
    <i
      ...
      :class="['p-dropdown-clear-icon', clearIcon]"
      @click="onClearClick"
      v-bind="clearIconProps"
    ></i>
    <div class="p-dropdown-trigger" v-if="!hideIndicator">
      <slot name="indicator">
    ...
    <Portal :appendTo="appendTo">
      ...
      >
        <div
          v-if="overlayVisible"
          :ref="overlayRef"
          :style="(panelStyle, dropdownPanelStyle)"
  ...
  methods: {
    ...
    onFirstHiddenFocus(event) {
      ...
      if (relatedTarget === this.$refs.focusInput) {
        const firstFocusableEl = DomHandler.getFirstFocusableElement(
          this.overlay,

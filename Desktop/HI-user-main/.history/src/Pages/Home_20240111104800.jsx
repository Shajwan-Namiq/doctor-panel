function Home() {
  return (
    <div className="mt-16 min-h-screen p-4 sm:px-10 md:px-20 lg:w-1/2 flex flex-col justify-center">
      <img
        className="object-cover w-full rounded-md h-60 border"
        ...
        alt="user"
      />
      <div className="mt-5 font-bold text-lg">Personal Information</div>
      <div className="mt-2">
        <span>Name:</span>
      ...
      {/* **********vital information*********** */}
      <div className="mt-5 font-bold text-lg">Vital Information</div>
      <div className="mt-2 flex justify-between items-center">
        <span>
          {' '}
      ...
      {/* ***************Emergency Contacts********** */}
      <div className="mt-5 font-bold text-lg">Emergency Contacts</div>
      <div className="mt-2 flex justify-between items-center">
        <span>
          {' '}
          <span>Name:</span>

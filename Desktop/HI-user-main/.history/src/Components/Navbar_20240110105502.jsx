    ...
    <div className={`bg-grayy text-gray-700 dark:bg-dark dark:text-grayy z-50`}>
      <div className="flex flex-col  ">
        ...
        >
          ...
          <div className="">
            <div
              className={`sm:hidden flex justify-between hover:bg-opacity-80 duration-500 hover:duration-500 items-center w-full h-full text-lg font-bold font-Poppins text-grayy `}
            >
              {/* <Theme /> */}

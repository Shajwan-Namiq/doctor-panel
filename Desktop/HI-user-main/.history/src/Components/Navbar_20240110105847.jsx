...
function Navbar() {
  ...
  return (
    <div className={`bg-grayy text-gray-700 dark:bg-dark dark:text-grayy z-50`}>
      <div className="flex flex-col  ">
        <div
          className={
            ' dark:bg-dark bg-opacity-70 dark:bg-opacity-70 bg-grayy px-6 sm:px-12 md:px-20 lg:px-26 xl:px-36 z-50   fixed w-full text-xl 2xl:text-2xl flex flex-row justify-between items-center bg-white  h-20 font-semibold '
          }
        >
                ...
                <div className="w-full items-center h-screen flex flex-col text-orange">
                  ...
                  {/* <div className="flex sm:hidden items-center ">
                    <a
                      href={cv}
                      download
                      className="mt-5 flex items-center text-sm font-semibold bg-orange text-grayy rounded px-6 py-1"
                    >
                      Resume <AiOutlineDownload className="ml-1 w-6 h-6" />
                    </a>
                  </div> */}
                </div>
              </div>

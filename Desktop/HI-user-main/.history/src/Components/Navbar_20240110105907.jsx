        ...
        >
          ...
          <div className="">
            ...
            >
              ...
              <div
                className={`
            bg-grayy dark:bg-dark dark:shadow-darkgray bg-white rounded-sm sm:hidden flex flex-col fixed w-3/5 top-0 z-40 right-0 shadow-lg transform duration-500 ease-in-out ${

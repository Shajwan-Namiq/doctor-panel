...
function Navbar() {
  ...
  return (
    //     <div className={`text-gray-700  z-50 flex justify-between items-center`}>
    <div className="flex top-0  z-50  fixed px-4 justify-between items-center bg-white h-10 w-full">
      {/* <div
          className={

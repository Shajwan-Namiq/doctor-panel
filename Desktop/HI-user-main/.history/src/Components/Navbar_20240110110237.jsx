        ...
        >
          ...
          <div className="">
            ...
            >
              ...
              <div
                className={`
            bg-grayy dark:bg-dark dark:shadow-darkgray bg-white rounded-sm  flex flex-col fixed w-3/5 lg:w-96 top-0 z-40 right-0 shadow-lg transform duration-500 ease-in-out ${
              open ? '-translate-x-0' : 'translate-x-full'
            }`}
              >
                <div className="flex justify-end h-16 lg:w-96">
                  <button
                ...
                <div className="w-full lg:w-96 items-center h-screen flex flex-col text-orange">
                  <Link
                    to="/"
                    onClick={() => setOpen(!open)}

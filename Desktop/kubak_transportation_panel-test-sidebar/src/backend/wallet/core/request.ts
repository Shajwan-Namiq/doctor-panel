...
import { requestStatus, walletRequestStatus } from "@/stores/common/requestStatus"
...
const sendRequest = async <T>(
  ...
  const requestConfig: AxiosRequestConfig = {
    ...
    headers: {
      ...
      "X-Auth-User": '{"Id":1,"Uid":"NQFWDCM8r9PsXG7Dl4qI9R76lTf1","DisplayName":"ahmad","Email":"ahmad.aea@gmail.com","PhoneNumber":null,"PhotoUrl":null,"EmailVerified":false,"Disabled":false,"Roles":[{"Name":"SuperAdmin"}]}',
    },
    data: body ?? formData,

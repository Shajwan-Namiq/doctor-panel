...
export class FilterToListOfDevices {
...
export class FilterListOfDevicesDto {
  appVersionFrom?: string;
  appVersionTo?: string;
  userIds?: Array<string>;
  deviceName?: string;
...
export function CreateMapToListOfDevicesDto(
  source: FilterListOfDevicesDto
): FilterToListOfDevices {
  return mapper.map(source, FilterListOfDevicesDto, FilterToListOfDevices);
}

...
} from "./mapperToBlockedUser/mapper";
...
async function getServantBlockList() {
  await UserBlockService.getAllUserBlocks({
    userIds: [route.params.id as string],
  }).then((res) => {
    blockList.value =
      createMapBlockServantListResponseToBlockServantListResponseDto(res.items);
  });
}

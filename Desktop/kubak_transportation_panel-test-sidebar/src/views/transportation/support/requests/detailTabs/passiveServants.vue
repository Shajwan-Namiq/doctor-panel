...
const passiveServants = ref();
getPassiveServants();
function getPassiveServants() {
  RequestService.getRequestPassiveServant(filterData.value).then((Response) => {
    passiveServants.value = Response;
  });
}

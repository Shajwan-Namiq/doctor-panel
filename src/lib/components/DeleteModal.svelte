...
<div class="flex items-center">
  ...
  >
    <div class="text-base leading-relaxed dark:text-red-600 text-red-600">
      بەڕاستی دەتەوێت ئەم تۆمارە بسڕیتەوە ؟
    </div>
    <div class="text-base leading-relaxed dark:text-red-600 text-red-600">
      ئەم پرۆسەیە ناتوانرێت هەڵبوەشێتەوە.
    </div>
    <svelte:fragment slot="footer">
      <Button on:click={handleDeleteClick} {color}>سڕینەوە</Button>
      <div />
      <Button color="alternative" class="hover:text-gray-700"
        >پاشگەزبونەوە</Button
      >
    </svelte:fragment>
  </Modal>

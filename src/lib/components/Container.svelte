<script lang="ts">
  ...
  <div class="wrapper bg-white rounded shadow w-full mt-5">
  <div class="header flex justify-between border-b p-2">
    ...
    <div class="buttons flex justify-center space-x-2">
    <!-- Left Arrow Button -->
    <button class="p-2 rounded-full bg-gray-100   hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300">
    ...
    <!-- Right Arrow Button -->
    <button class="p-2 rounded-full bg-gray-100 text-whit hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
